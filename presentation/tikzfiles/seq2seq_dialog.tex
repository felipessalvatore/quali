...
%  timestep decoder 2
\rnndecoderSimpl{(2)}{I}{tt2}{right=40pt of htt1};

%  timestep decoder 3
\rnndecoderSimpl{(3)}{just}{tt3}{right=40pt of htt2};

%  timestep decoder 4
\rnndecoder{(4)}{start}{tt4}{right=40pt of htt3};
...
% text
\node[textonly, left=40pt of yhattt4] (result) {{\Large $P(x^{(5)}| $<eos>$ \text{, I, just, start,  }\vect{h}^{(7)})$}};
